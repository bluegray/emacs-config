...
(custom-set-faces
 ...
 '(rainbow-delimiters-depth-1-face ((((background dark)) (:foreground "#66e"))))
 '(rainbow-delimiters-depth-2-face ((((background dark)) (:foreground "#e66"))))
 '(rainbow-delimiters-depth-3-face ((((background dark)) (:foreground "#6e6"))))
 '(rainbow-delimiters-depth-4-face ((((background dark)) (:foreground "#ee6"))))
 '(rainbow-delimiters-depth-5-face ((((background dark)) (:foreground "#6ee"))))
 '(rainbow-delimiters-depth-6-face ((((background dark)) (:foreground "#e6e"))))
